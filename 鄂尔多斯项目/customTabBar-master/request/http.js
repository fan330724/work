...
export default {
  ...
  menuSignIn(props) {
    return request({
      url: url + "/api-min/qrcode/menuSignIn",
      data: {
        ...props
      },
      method: 'post',
  ...
  queryClass(props) {
    return request({
      url: url + "/api-min/index/queryClass",
      data: {
        ...props
      },
      method: 'post',
   ...
   * 历史班级/班级详情  查询班级课程
   */
  queryClassCourse(props) {
    return request({
      url: url + "/api-min/index/queryClassCourse",
      data: {
        ...props
      },
      method: 'post',
   ...
   * 历史班级/班级详情  获取课程评价
   */
  queryCourseAppraise(props) {
    return request({
      url: url + "/api-min/index/queryCourseAppraise",
      data: {
        ...props
      },
      method: 'post',
  ...
  queryVideo(props) {
    return request({
      url: url + "/api-min/index/queryVideo",
      data: {
        ...props
      },
      method: 'post',
  ...
  queryIdVideo(props) {
    return request({
      url: url + "/api-min/index/queryIdVideo",
      data: {
        ...props
      },
      method: 'post',
  ...
  queryStayList(props) {
    return request({
      url: url + "/api-min/index/queryStayList",
      data: {
        ...props
      },
      method: 'post',
   ...
   * 获取住宿评价
   */
  getStayAppraiseList(props) {
    return request({
      url: url + "/api-min/index/getStayAppraiseList",
      data: {
        ...props
      },
      method: 'post',
  ...
  getMinMessage(props) {
    return request({
      url: url + "/api-min/index/getMinMessageList",
      data: {
        ...props
      },
      method: 'post',
  ...
  getSignInList(props) {
    return request({
      url: url + "/api-min/course/getSignInList",
      data: {
        ...props
      },
      method: 'post',
   ...
   * 其它端考勤列表
   */
  getSignInList1(props) {
    return request({
      url: url + "/api-min/index/getSignInList",
      data: {
        ...props
      },
      method: 'post',
  ...
  menuSignin1(props) {
    return request({
      url: url + "/api-min/index/menuSignin",
      data: {
        ...props
      },
      method: 'post',
