<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['intel:studentCourse:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['intel:studentCourse:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column label="学员名称" align="center" prop="userName" />
      <el-table-column
        label="时间"
        align="center"
        prop="createTime"
      ...
      >
        <template slot-scope="scope">
          <!-- <el-button
            ...
            type="text"
            icon="el-icon-edit"
            @click="handleDining(scope.row)"
            v-hasPermi="['intel:dining:edit']"
          ...
          <!-- <el-button
            ...
            v-hasPermi="['intel:studentCourse:edit']"
            >修改</el-button
          > -->
          <el-button
            size="mini"
