    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报名内容" prop="baomingneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="报名内容"
                  v-model="ruleForm.baomingneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baomingneirong" label="报名内容" prop="baomingneirong">
                    <span>{{ruleForm.baomingneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
