<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('baomingxinxi','开始') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="renwukaishiCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'开始':'' }}</el-button>
                <el-button v-if="isAuth('baomingxinxi','开始') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="renwukaishiCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'开始':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('baomingxinxi','开始') && contents.tableBtnIcon == 0" type="success" size="mini" @click="renwukaishiCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'开始':'' }}</el-button>
                <el-button v-if="isAuth('baomingxinxi','结束') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="renwujieshuCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'结束':'' }}</el-button>
                <el-button v-if="isAuth('baomingxinxi','结束') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="renwujieshuCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'结束':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('baomingxinxi','结束') && contents.tableBtnIcon == 0" type="success" size="mini" @click="renwujieshuCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'结束':'' }}</el-button>
    ...
    <renwukaishi-cross-add-or-update v-if="renwukaishiCrossAddOrUpdateFlag" :parent="this" ref="renwukaishiCrossaddOrUpdate"></renwukaishi-cross-add-or-update>
    <renwujieshu-cross-add-or-update v-if="renwujieshuCrossAddOrUpdateFlag" :parent="this" ref="renwujieshuCrossaddOrUpdate"></renwujieshu-cross-add-or-update>
...
import renwukaishiCrossAddOrUpdate from "../renwukaishi/add-or-update";
import renwujieshuCrossAddOrUpdate from "../renwujieshu/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      renwukaishiCrossAddOrUpdateFlag: false,
      renwujieshuCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    renwukaishiCrossAddOrUpdate,
    renwujieshuCrossAddOrUpdate,
  },
  methods: {
    ...
    renwukaishiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
	if(crossOptAudit=='是'&&row.sfsh!='是') {
      ...
      this.renwukaishiCrossAddOrUpdateFlag = true;
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.renwukaishiCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.renwukaishiCrossaddOrUpdate.init(row.id,type);
      });
    },
    renwujieshuCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
	if(crossOptAudit=='是'&&row.sfsh!='是') {
	    this.$message({
	      message: "请审核通过后再操作",
	      type: "success",
      ...
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.renwujieshuCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','baomingxinxi');
      this.$storage.set('statusColumnName',statusColumnName);
      this.$storage.set('statusColumnValue',statusColumnValue);
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.renwujieshuCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.renwujieshuCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          qingxiemingcheng: row.qingxiemingcheng,
