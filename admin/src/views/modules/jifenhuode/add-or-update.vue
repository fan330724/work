<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="获得说明" prop="huodeshuoming">
          <el-input v-model="ruleForm.huodeshuoming" 
              placeholder="获得说明" clearable  :readonly="ro.huodeshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="获得说明" prop="huodeshuoming">
              <el-input v-model="ruleForm.huodeshuoming" 
                placeholder="获得说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="获得时间" prop="huodeshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.huodeshijian" 
                type="datetime"
                :readonly="ro.huodeshijian"
                placeholder="获得时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huodeshijian" label="获得时间" prop="huodeshijian">
              <el-input v-model="ruleForm.huodeshijian" 
                placeholder="获得时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.huodeshijian = this.getCurDateTime()
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jifenhuode/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jifenhuodeCrossAddOrUpdateFlag = false;
						 this.parent.search();
