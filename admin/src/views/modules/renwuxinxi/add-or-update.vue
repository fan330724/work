<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="任务类型" prop="renwuleixing">
          <el-select :disabled="ro.renwuleixing" v-model="ruleForm.renwuleixing" placeholder="请选择任务类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="获得积分" prop="huodejifen">
          <el-input v-model="ruleForm.huodejifen" 
              placeholder="获得积分" clearable  :readonly="ro.huodejifen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="获得积分" prop="huodejifen">
              <el-input v-model="ruleForm.huodejifen" 
                placeholder="获得积分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任务地点" prop="renwudidian">
          <el-input v-model="ruleForm.renwudidian" 
              placeholder="任务地点" clearable  :readonly="ro.renwudidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任务地点" prop="renwudidian">
              <el-input v-model="ruleForm.renwudidian" 
                placeholder="任务地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="青协名称" prop="qingxiemingcheng">
          <el-input v-model="ruleForm.qingxiemingcheng" 
              placeholder="青协名称" clearable  :readonly="ro.qingxiemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="青协名称" prop="qingxiemingcheng">
              <el-input v-model="ruleForm.qingxiemingcheng" 
                placeholder="青协名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.renwuyaoqiu = this.ruleForm.renwuyaoqiu.replace(reg,'../../../springboot2739u/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `renwuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.renwuxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
