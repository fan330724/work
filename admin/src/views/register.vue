  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='qingxie'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='qingxie'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='qingxie'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='qingxie'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='qingxie'" class="input-group">
			   <div class="label">青协名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qingxiemingcheng" class="input" type="text" placeholder="青协名称">
			   </div>
			 </div> -->
			<el-form-item label="青协名称" class="input" v-if="tableName=='qingxie'">
			  <el-input v-model="ruleForm.qingxiemingcheng" autocomplete="off" placeholder="青协名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qingxie'" class="input-group">
			   <div class="label">姓名</div>
			   <div class="input-container">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='qingxie'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qingxie'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='qingxie'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='qingxie'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `qingxie` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
