;(function($){
	...
	function writeVal(data, el, curGlobalIndex){
		...
		// 	$(el).text(text)
		// }
		var obj = {p:`${location['0'][global[curGlobalIndex].pcaindex.p]}`,c:`${location['0,'+global[curGlobalIndex].pcaindex.p][global[curGlobalIndex].pcaindex.c] }`,a:`${location['0,'+global[curGlobalIndex].pcaindex.p+','+global[curGlobalIndex].pcaindex.c][global[curGlobalIndex].pcaindex.a]}`}
		data.pick && data.pick(obj);
	}
